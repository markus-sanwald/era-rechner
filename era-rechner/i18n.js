...
const TRANSLATIONS = {
  de: {
    ...
    faqShowMore: "Alle %n Fragen anzeigen",
    faqShowLess: "Weniger anzeigen",
    ...
    faqTariftabelleQ: "Was ist die IG Metall Tariftabelle 2026?",
    faqTariftabelleA: "\u201eTariftabelle\u201c und \u201eERA-Entgelttabelle\u201c bezeichnen dasselbe: die Tabelle der tariflichen Monatsentgelte in der Metall- und Elektroindustrie, gestaffelt nach Entgeltgruppe (EG\u00a01 bis EG\u00a017). Sie unterscheidet sich je Bundesland und Tarifgebiet. Die vollst\u00e4ndigen Werte deines Tarifgebiets findest du oben im Rechner oder auf den einzelnen <a href=\"#entgelttabellen\">Entgelttabellen-Unterseiten</a>.",
    ...
    faqAnspruchA: "Anspruch auf Urlaubsgeld, T-ZUG A, T-ZUG B und das Transformationsgeld (T-Geld) besteht erst nach sechs Monaten ununterbrochener Betriebszugeh\u00f6rigkeit. Ma\u00dfgeblich ist der jeweilige Auszahlungsmonat: Urlaubsgeld wird im Juni ausgezahlt (Stichtag 30. Juni, Eintritt also sp\u00e4testens Ende Dezember des Vorjahres), T-ZUG A im Juli (Stichtag 31. Juli, Eintritt sp\u00e4testens 31. Januar). Bei T-Geld und T-ZUG B sind die Auszahlungsmonate ab 2026 getauscht: T-Geld kommt im Juli (Stichtag 31. Juli), T-ZUG B im Februar (Stichtag Ende Februar \u2013 Eintritt sp\u00e4testens Ende August des Vorjahres); bis 2025 war es umgekehrt. Tipp: Trage dein Eintrittsdatum im Rechner ein, dann wird der Anspruch automatisch gepr\u00fcft. Bleibt das Feld leer, geht der Rechner davon aus, dass du bereits l\u00e4nger als sechs Monate im Betrieb bist.",
    ...
    // Trust-Badges
    ariaTrust: "Vorteile des Rechners",
    trustOfficialTitle: "Offizielle Daten",
    trustOfficialText: "Basierend auf den offiziellen IG Metall Tarifabschlüssen 2025/2026 – regelmäßig aktualisiert.",
    trustPrivacyTitle: "100 % Datenschutz",
    trustPrivacyText: "Keine Speicherung, kein Tracking – alle Berechnungen laufen direkt in deinem Browser.",
    trustOpenSourceTitle: "Open Source",
    trustOpenSourceText: "Quellcode frei einsehbar auf GitHub (MIT-Lizenz) – transparent und nachprüfbar.",
    trustOpenSourceCta: "Auf GitHub ansehen →",
    trustAdFreeTitle: "Werbefrei",
    trustAdFreeText: "Unabhängiges Privatprojekt – kostenlos und ohne Werbung.",
    trustAdFreeCta: "Mit einer Spende unterstützen →",
    ...
    footerDonate: "Dieses Projekt ist werbefrei und open-source. Unterstütze es mit einer Spende via <a href=\"https://paypal.me/erarechner\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a>.",
    ...
    gA_betriebsz: "Die Dauer der ununterbrochenen Zugeh\u00f6rigkeit zum Betrieb. Sie beeinflusst ma\u00dfgeblich den Weihnachtsgeld-Satz: Bis zu einem Jahr Zugeh\u00f6rigkeit erh\u00e4ltst du 25\u00a0%, ab einem Jahr 35\u00a0%, ab drei Jahren 45\u00a0% und ab f\u00fcnf Jahren 55\u00a0% eines Monatsentgelts. Ma\u00dfgeblicher Stichtag f\u00fcr die Berechnung ist der <strong>31.\u00a0Dezember des jeweiligen Tarifjahres</strong> \u2013 es z\u00e4hlt also die vollendete Betriebszugeh\u00f6rigkeit bis Jahresende, nicht der Auszahlungszeitpunkt im November. \u00dcber den Weihnachtsgeld-Satz hinaus entscheidet die Betriebszugeh\u00f6rigkeit auch \u00fcber den grunds\u00e4tzlichen Anspruch auf die \u00fcbrigen Sonderzahlungen: Urlaubsgeld, T-ZUG A, T-ZUG B und das Transformationsgeld (T-Geld) gibt es erst nach sechs Monaten ununterbrochener Betriebszugeh\u00f6rigkeit. Ma\u00dfgeblich ist dabei jeweils der Auszahlungsmonat der Zahlung (Urlaubsgeld im Juni, T-ZUG A im Juli; T-Geld und T-ZUG B je nach Jahr im Juli bzw. Februar), nicht der 31. Dezember. Im <a href=\"/\">ERA Rechner</a> wird die Betriebszugeh\u00f6rigkeit automatisch aus dem eingetragenen Eintrittsdatum berechnet.",
  ...
  en: {
    ...
    faqShowMore: "Show all %n questions",
    ...
    faqTariftabelleQ: "What is the IG Metall pay table (Tariftabelle) 2026?",
    faqTariftabelleA: "\"Tariftabelle\" and \"ERA-Entgelttabelle\" (salary table) mean the same thing: the table of collectively agreed monthly pay in the metal and electrical industry, broken down by pay group (EG 1 to EG 17). It varies by federal state and bargaining region. You can find the full values for your region above in the calculator or on the individual <a href=\"#entgelttabellen\">salary table sub-pages</a>.",
    ...
    faqAnspruchA: "Entitlement to holiday pay, T-ZUG A, T-ZUG B and the transformation payment (T-Geld) only arises after six months of uninterrupted company tenure. What matters is the respective payout month: holiday pay is paid in June (reference date 30 June, so start date no later than the end of December of the previous year), T-ZUG A in July (reference date 31 July, start date no later than 31 January). For T-Geld and T-ZUG B the payout months are swapped from 2026: T-Geld is paid in July (reference date 31 July), T-ZUG B in February (reference date end of February – start date no later than the end of August of the previous year); until 2025 it was the other way round. Tip: enter your start date in the calculator and entitlement is checked automatically. If the field is left empty, the calculator assumes you have already been with the company for more than six months.",
    ...
    // Trust badges
    ariaTrust: "Calculator benefits",
    trustOfficialTitle: "Official Data",
    trustOfficialText: "Based on the official IG Metall collective agreements 2025/2026 – updated regularly.",
    trustPrivacyTitle: "100% Privacy",
    trustPrivacyText: "No storage, no tracking – all calculations run directly in your browser.",
    trustOpenSourceTitle: "Open Source",
    trustOpenSourceText: "Source code freely available on GitHub (MIT license) – transparent and verifiable.",
    trustOpenSourceCta: "View on GitHub →",
    trustAdFreeTitle: "Ad-free",
    trustAdFreeText: "Independent private project – free and without advertising.",
    trustAdFreeCta: "Support with a donation →",
    ...
    footerDonate: "This project is ad-free and open-source. Support it with a donation via <a href=\"https://paypal.me/erarechner\" target=\"_blank\" rel=\"noopener noreferrer\">PayPal</a>.",
    ...
    gA_betriebsz: "The duration of uninterrupted employment with the company. It mainly determines the Christmas bonus rate: up to one year 25\u00a0%, from one year 35\u00a0%, from three years 45\u00a0%, and from five years 55\u00a0% of one monthly salary. The relevant reference date is <strong>31 December of the respective tariff year</strong> \u2013 what counts is the completed tenure by year-end, not the payment date in November. Beyond the Christmas bonus rate, tenure also determines basic entitlement to the other special payments: holiday pay, T-ZUG A, T-ZUG B and the transformation payment (T-Geld) are only granted after six months of uninterrupted company tenure. What matters here is the respective payout month (holiday pay in June, T-ZUG A in July; T-Geld and T-ZUG B in July or February depending on the year), not 31 December. In the <a href=\"/\">ERA Pay Calculator</a>, tenure is automatically calculated from the entered start date.",
    ...
    gA_transformation: "An annual special payment of 18.4\u00a0% of one monthly salary, effective from 2024. Agreed in the 2021 wage round, it supports employees during the industry's structural change (digitalisation, electromobility). It is calculated in the same way as holiday pay and Christmas bonus, based on the monthly salary including performance allowance. From 2026, T-Geld is paid in July (previously February, swapped with T-ZUG B) and can be \"differentiated\" – i.e. reduced or deferred – by economically struggling companies (when the net return on sales falls below 2.3%); it took over this role from T-ZUG B. Entitlement only arises after six months of uninterrupted company tenure, measured as at the payout month: from 2026 at the 31 July reference date (start date no later than 31 January), until 2025 at the end-of-February reference date. In the calculator this is only applied if a start date is entered.",
    gQ_tzugA: "T-ZUG A \u2013 Additional Tariff Payment A",
    gA_tzugA: "An annual special payment of 27.5\u00a0% of one monthly salary. The employee can choose: either the cash payment or up to 8 paid days off \u2013 but only under certain conditions (e.g. caring for relatives, childcare for children under 8, or shift work). T-ZUG\u00a0A is calculated based on the monthly salary including performance allowance. Entitlement only arises after six months of uninterrupted company tenure as at the July payout (reference date 31 July, start date no later than 31 January). In the calculator, the option can be set under \"More options\"; the six-month rule only applies if a start date is entered.",
    gQ_tzugB: "T-ZUG B \u2013 Additional Tariff Payment B",
    gA_tzugB: "A fixed annual amount based on the reference salary of the respective collective bargaining region. T-ZUG\u00a0B is the same for all employees in a region \u2013 regardless of their personal pay group or performance allowance. From 2026, T-ZUG B rises from 18.5% to 26.5% of the reference salary and is paid in February (previously July, swapped with the transformation payment). At company level, the \"differentiation\" since then applies to the transformation payment rather than to T-ZUG B – so T-ZUG B is preserved as a social component. Entitlement only arises after six months of uninterrupted company tenure, measured as at the payout month: from 2026 at the end-of-February reference date (start date no later than the end of August of the previous year), until 2025 at the 31 July reference date. In the calculator this is only applied if a start date is entered. For part-time employees, T-ZUG\u00a0B is granted proportionally.",
    gQ_urlaubsgeld: "Holiday Pay (Urlaubsgeld)",
    gA_urlaubsgeld: "An annual special payment of 69\u00a0% of one monthly salary (72\u00a0% in NRW). Holiday pay is usually paid in June (by 30 June at the latest) and is calculated based on the monthly salary including performance allowance. It is a collectively agreed benefit and applies to all employees in the respective ERA collective bargaining region. Entitlement only arises after six months of uninterrupted company tenure; the relevant date is the June payout (reference date 30 June, start date no later than the end of December of the previous year). In the <a href=\"/\">ERA calculator</a> this is only applied if a start date is entered – otherwise it is assumed the six months are already met.",
